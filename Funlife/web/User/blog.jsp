                            ...
                            <div class="single-post row">
                                <div class="col-lg-12">
                                    <div class="feature-img">
                                        <img class="img-fluid" src="./User/assets/images/blog-details/feature-img1.jpg" alt="">
                                    </div>									
                                </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <img class="img-fluid" src="./User/assets/images/blog-details/post-img1.jpg" alt="">
                                        </div>
                                        <div class="col-6">
                                            <img class="img-fluid" src="./User/assets/images/blog-details/post-img2.jpg" alt="">
                                        </div>	
                            ...
                            <div class="comments-area">
                                ...
                                <div class="comment-list">
                                    <div class="single-comment justify-content-between d-flex">
                                        <div class="user justify-content-between d-flex">
                                            <div class="thumb">
                                                <img src="./User/assets/images/blog-details/c1.jpg" alt="">
                                            </div>
                                            <div class="desc">
                                ...
                                <div class="comment-list left-padding">
                                    <div class="single-comment justify-content-between d-flex">
                                        <div class="user justify-content-between d-flex">
                                            <div class="thumb">
                                                <img src="./User/assets/images/blog-details/c2.jpg" alt="">
                                            </div>
                                            <div class="desc">
                                ...
                                <div class="comment-list left-padding">
                                    <div class="single-comment justify-content-between d-flex">
                                        <div class="user justify-content-between d-flex">
                                            <div class="thumb">
                                                <img src="./User/assets/images/blog-details/c3.jpg" alt="">
                                            </div>
                                            <div class="desc">
                                ...
                                <div class="comment-list">
                                    <div class="single-comment justify-content-between d-flex">
                                        <div class="user justify-content-between d-flex">
                                            <div class="thumb">
                                                <img src="./User/assets/images/blog-details/c4.jpg" alt="">
                                            </div>
                                            <div class="desc">
                                ...
                                <div class="comment-list">
                                    <div class="single-comment justify-content-between d-flex">
                                        <div class="user justify-content-between d-flex">
                                            <div class="thumb">
                                                <img src="./User/assets/images/blog-details/c5.jpg" alt="">
                                            </div>
                                            <div class="desc">
